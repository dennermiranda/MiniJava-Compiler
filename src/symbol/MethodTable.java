...
public class MethodTable {
	...
	private String Name;
	private Type t;
	private LinkedHashMap<Symbol, Type> varTable; //Variaveis locais
	private LinkedHashMap<Symbol, Type> paramTable; // Binding de parametros
	...
	public MethodTable(String s, Type t) {
		this.t = t;
		Name = s;
		varTable = new LinkedHashMap<Symbol, Type>();
		paramTable = new LinkedHashMap<Symbol, Type>();
	...
	public void addLocal(Symbol id, Type t) {
	...
	public HashMap<Symbol, Type> getLocals() {
		// TODO Auto-generated method stub
		return varTable;
	}
